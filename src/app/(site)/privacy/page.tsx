...
export const metadata: Metadata = buildMetadata({
  title: "Privacybeleid",
  description:
    "Privacybeleid van Anurak Thai: welke persoonsgegevens we verwerken bij reservaties en bestellingen, waarom, hoe lang we ze bewaren en welke rechten je hebt onder de GDPR/AVG.",
  path: "/privacy",
});
