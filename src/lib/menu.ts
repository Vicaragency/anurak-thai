/**
 * Menukaart Anurak Thai (Thaise gerechten + richtprijzen).
...
export const MENU_CATEGORIES: MenuCategory[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { code: "T12A.", th: "", name: "Heart of Anurak Thai", price: "€15.00" },
...
export const REVIEWS = [
  {
    name: "Bart",
    rating: 5,
    text: "Heerlijk gegeten! Verse, authentieke Thaise gerechten en een gezellige sfeer in het hart van Roeselare. Zeker een aanrader.",
  },
  {
    name: "Sofie",
    rating: 5,
  ...
  },
  {
    name: "Thomas",
    rating: 5,
    text: "Beste Thai van Roeselare. Ruime keuze, eerlijke prijzen en alles smaakt vers bereid. Reserveren is wel aangeraden.",
  },
] as const;
